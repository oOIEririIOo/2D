...
public class FemalGoblinIdleState : IState
...
public class FemalGoblinPatrolState : IState
{
...
public class FemalGoblinChaseState : IState
{
...
public class FemalGoblinRangedAttackState : IState
{
    public override void OnEnter(FSM enemy)
    {
        enemy.anim.SetBool("run", false);
...
public class FemalGoblinAttackState : IState
{
    public override void OnEnter(FSM enemy)
    {
...
public class FemalGoblinHurtState : IState
{
    float hurtTime;
    public override void OnEnter(FSM enemy)
    {
...
public class FemalGoblinDeadState : IState
{
    public override void OnEnter(FSM enemy)
    {
        enemy.anim.SetBool("run", false);
